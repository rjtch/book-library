...
func run() error {
	...
	var cfg struct {
		DB struct {
			User       string `conf:"default:book"`
			Password   string `conf:"default:postgres-password,noprint"`
			Host       string `conf:"default:localhost"`
			Name       string `conf:"default:book"`
...
func useradd(cfg database.Config, email, password string) error {
	...
	fmt.Printf("Admin users will be created with email %q and password %q\n", email, password)
