...
import { LoanInfoList } from '../model/models';
...
export class LoansService {
    ...
    public deleteLoan(userId: string, loanId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        credential = this.configuration.lookupCredential('sessionCookie');
        if (credential) {
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listAllLoans(userId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<LoanInfoList>>;
    public listAllLoans(userId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<LoanInfoList>>>;
    public listAllLoans(userId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<LoanInfoList>>>;
    public listAllLoans(userId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<Array<LoanInfoList>>(`${this.configuration.basePath}/v1/loans/${encodeURIComponent(String(userId))}/all`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
