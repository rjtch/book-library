...
RUN mkdir -p /go/src/github.com/book-library

# Copy the module files first and then download the dependencies. If this
# doesn't change, we won't need to do this again in future builds.
COPY go.* /go/src/github.com/book-library/
...
ARG PACKAGE_NAME
ARG PACKAGE_PREFIX
COPY --from=build_metrics /go/src/github.com/book-library/cmd/${PACKAGE_PREFIX}${PACKAGE_NAME}/${PACKAGE_NAME} /app-library/main
WORKDIR /app-library
